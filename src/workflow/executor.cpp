...
std::vector<std::vector<std::string>> execute(std::string implementation, std::string julia_impl, std::string fname, std::vector<std::string> input_files, std::size_t num_outputs)
{
