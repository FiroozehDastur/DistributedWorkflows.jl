...
include("/path/to/DistributedWorkflows.jl/examples/petri_nets/multi_module_net.jl")# add code for multi_module.jl
...
jl_impl = "/path/to/DistributedWorkflows.jl/examples/applications/multi_module/multi_module.jl"
...
input_mm = input_pair("input_file", "/path/to/DistributedWorkflows.jl/examples/serialized_data/int1_julia_nativefmt")
